...
### Task 5 - Wheels spinning

I simultaneously set the PWM values for left and right sides of wheels to let them spin:

![wheel_spinning_code](/assets/images/lab4/wheel_spinning_code.png "wheel_spinning_code")

The wheels spinning video is:

![wheel_spinning](https://youtube.com/shorts/srrAF9U4jSw?feature=share "wheel_spinning")
