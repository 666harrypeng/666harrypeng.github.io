...
toc: true
redirect_from:
  - /projects/autonomous-and-fast-robots-cornell/lab11-localization-on-real-robot/
---
...
All the tasks in this lab are mostly based on the simulation from the last lab ([Lab10](/projects/autonomous_and_fast_robots/lab10_localization_with_bayes_filter/))
...
![opt_sim_plot](../attachments/lab11/opt_sim_plot.png "opt_sim_plot")
...
Now, the car should go for the full 360 degree scans by the ToF sensor, transmit the data by Bluetooth, and pass the data through the Bayes filter which was defined in [Lab10](/projects/autonomous_and_fast_robots/lab10_localization_with_bayes_filter/), to predict the robot's current position in our space.

The observation loop was implemented as follows:

![perform_observation_loop_code](../attachments/lab11/perform_observation_loop_code.png "perform_observation_loop_code")
...
![p3](../attachments/lab11/p3.png "p3")

![p3_plot](../attachments/lab11/p3_plot.png "p3_plot")

* (0 ft, 3 ft, 0 deg)

![p1](../attachments/lab11/p1.png "p1")

![p1_plot](../attachments/lab11/p1_plot.png "p1_plot")

* (5 ft, -3ft, 0 deg)

![p4](../attachments/lab11/p4.png "p4")

![p4_plot](../attachments/lab11/p4_plot.png "p4_plot")

* (5 ft, 3 ft, 0 deg)

![p2](../attachments/lab11/p2.png "p2")

![p2_plot](../attachments/lab11/p2_plot.png "p2_plot")
