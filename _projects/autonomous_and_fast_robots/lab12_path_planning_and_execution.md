...
toc: true
redirect_from:
  - /projects/autonomous-and-fast-robots-cornell/lab12-path-planning-and-execution/
---
...
![waypoints](../attachments/lab12/waypoints.png "waypoints")
...
Based on the localization results of four sample waypoints from [lab11](/projects/autonomous_and_fast_robots/lab11_localization_on_real_robot/), I first tried the localization method to traverse the waypoints.
...
![perform_observation_code](../attachments/lab12/perform_observation_code.png "perform_observation_code")
...
![get_cur_pose_code](../attachments/lab12/get_cur_pose_code.png "get_cur_pose_code")

The ***compute_control*** part is just the same as the lab11.

The main ***navigation*** function is like:

![navigation_code](../attachments/lab12/navigation_code.png "navigation_code")
...
![waypoints_data_preprocess](../attachments/lab12/waypoints_data_preprocess.png "waypoints_data_preprocess")
...
![waypoints_data](../attachments/lab12/waypoints_data.png "waypoints_data")
...
![localization_test_prediction_plot](../attachments/lab12/localization_test_prediction_plot.png "localization_test_prediction_plot")
...
![pid_angle_precision](../attachments/lab12/pid_angle_precision.png "pid_angle_precision")
