...
toc: true
redirect_from:
  - /projects/autonomous-and-fast-robots-cornell/lab1-the-artemis-board-and-bluetooth/
---
{% include toc %}
...
![BLE MAC Address](../attachments/lab1/ble_MAC.png "Arduino IDE prints BLE MAC Address")
...
![BLE Connection Success](../attachments/lab1/ble_connection_success.png "Our computer successfully connects the Artemis board")
...
![echo command](../attachments/lab1/echo_command.png "echo command implementation")
...
![echo command output](../attachments/lab1/echo_command_output.png "echo command output")
...
![Get Time Millis](../attachments/lab1/GET_TIME_MILLIS.png "get time millis")

And ran the command in ***demo.ipynb*** and get the return output:

![Get Time Millis Output](../attachments/lab1/GET_TIME_MILLIS_output.png "get time millis output")
...
![time handler](../attachments/lab1/time_handler.png "time handler")
...
![Send Time Stamps](../attachments/lab1/SEND_TIME_STAMPS.png "send time stamps")
...
![Time Stamps data](../attachments/lab1/SEND_TIME_STAMPS_data.png "time stamps data")
![time stamps data rate](../attachments/lab1/time_stamps_data_rate.png "data transfer rate")
...
![Add Time Stamps](../attachments/lab1/ADD_TIME_STAMPS.png "Add Time Stamps")
...
![Send Time Data](../attachments/lab1/SEND_TIME_DATA.png "Send time data")
![Send Time Data output from Arduino](../attachments/lab1/SEND_TIME_DATA_ino.png "Send time data output from Arduino")
...
![Add Temp Stamps](../attachments/lab1/ADD_TEMP_STAMPS.png "Add Temp and Time Stamps")
...
![Get Temp Readings](../attachments/lab1/GET_TEMP_READINGS.png "Get temp readings")
...
![Get Temp Readings output1](../attachments/lab1/GET_TEMP_READINGS_output1.png "Temp readings output1")

![Get Temp Readings output2](../attachments/lab1/GET_TEMP_READINGS_output2.png "Temp readings output2")
...
![second_method_record_rate](../attachments/lab1/second_method_record_rate.png "second_method_record_rate")
...
![memory_store_limit](../attachments/lab1/memory_store_limit.png "memory_store_limit")
