...
toc: true
redirect_from:
  - /projects/autonomous-and-fast-robots-cornell/lab2-imu/
---
{% include toc %}
...
![imu_connection](../attachments/lab2/imu_connection.JPG "imu_connection")
...
![IMU_example_code_working](../attachments/lab2/IMU_example_code_working.png "IMU_example_code_working")
...
![pitch_roll_equations](../attachments/lab2/pitch_roll_equations.png "pitch_roll_equations")
...
![pitch0_roll0](../attachments/lab2/pitch0_roll0.png "pitch0_roll0")

* -90 degrees pitch

![pitch-90](../attachments/lab2/pitch-90.png "pitch-90")

* 90 degrees pitch

![pitch90](../attachments/lab2/pitch90.png "pitch90")

* -90 degrees roll

![roll-90](../attachments/lab2/roll-90.png "roll-90")

* 90 degrees roll

![roll90](../attachments/lab2/roll90.png "roll90")
...
![display_pitch_roll_data](../attachments/lab2/display_pitch_roll_data.png "display_pitch_roll_data")

I applied FFT to the data and analysed the frequencies composition as follows:

![fft_image](../attachments/lab2/fft_image.png "fft_image")
...
![gyr_equation](../attachments/lab2/gyr_equation.png "gyr_equation")

I implemented the calculation methods in the Artemis code as follows:

![gyr_code](../attachments/lab2/gyr_code.png "gyr_code")
...
![gyr_data_sample](../attachments/lab2/gyr_data_sample.png "gyr_data_sample")
...
![filter_code](../attachments/lab2/filter_code.png "filter_code")
...
![no_filter](../attachments/lab2/no_filter.png "no_filter")

With filter, curves were:

![filter_0.2](../attachments/lab2/filter_0.2.png "filter_0.2")
...
![lab2_sample_data_code](../attachments/lab2/lab2_sample_data_code.png "lab2_sample_data_code")

Also, I modified my notification handler accordingly, and got the outputs shown below:

![handler_update](../attachments/lab2/handler_update.png "handler_update")

After I converted the data type of the elements in arrays from ***string*** into ***float*** and ***int***, I calculated the sampling speed:

![sample_speed](../attachments/lab2/sample_speed.png "sample_speed")
