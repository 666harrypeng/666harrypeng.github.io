...
toc: true
redirect_from:
  - /projects/autonomous-and-fast-robots-cornell/lab3-time-of-flight-tof-sensor/
---
...
![I2C_sensor_address](../attachments/lab3/I2C_sensor_address.png "I2C_sensor_address")
...
![set_two_sensors](../attachments/lab3/set_two_sensors.png "set_two_sensors")

Based on this method of setting up the two sensors, we should wiring the components in this way:

![wiring_diagram](../attachments/lab3/wiring_diagram.jpeg "wiring_diagram")
...
![picture_two_sensors](../attachments/lab3/picture_two_sensors.jpg "picture_two_sensors")
...
![tof_sensor_mode](../attachments/lab3/tof_sensor_mode.png "tof_sensor_mode")
...
![two_sensors_working](../attachments/lab3/two_sensors_working.png "two_sensors_working")

### Task 5 - ToF Sampling Rate

I modified my code and let the sensors get the readings only when they were ready.

![speed_up_sensor_code](../attachments/lab3/speed_up_sensor_code.png "speed_up_sensor_code")

And I got the output from the Artemis with the time sample and the distance readings.

![sensor_speed_output](../attachments/lab3/sensor_speed_output.png "sensor_speed_output")

I selected this part of the output as the "sample", and I calculated the rates:

![sensor_speed_sample_rate](../attachments/lab3/sensor_speed_sample_rate.png "sensor_speed_sample_rate")
...
![battery_charge_board](../attachments/lab3/battery_charge_board.JPG "battery charge board")
...
![handler_store_stamps](../attachments/lab3/handler_store_stamps.png "handler_store_stamps")

Later, I plotted the curves of ***time - dist1*** and ***time - dist2***, which was almost as expected.

![time_dist_plot](../attachments/lab3/time_dist_plot.png "time_dist_plot")
