...
toc: true
redirect_from:
  - /projects/autonomous-and-fast-robots-cornell/lab4-motors-and-open-loop-control/
---
{% include toc %}
...
![intended_connection](../attachments/lab4/intended_connection.png "intended_connection")
...
![oscilloscope](../attachments/lab4/oscilloscope.JPG "oscilloscope")

![power_supply](../attachments/lab4/power_supply.JPG "power_supply")
...
![motor_driver_io_test_code](../attachments/lab4/motor_driver_io_test_code.png "motor_driver_io_test_code")
...
![motor_driver_test_wire_connection](../attachments/lab4/motor_driver_test_wire_connection.JPG "motor_driver_test_wire_connection")

The oscilloscope image is :

![oscilloscope_driver_test](../attachments/lab4/oscilloscope_driver_test.JPG "oscilloscope_driver_test")
...
![wheel_spinning_code](../attachments/lab4/wheel_spinning_code.png "wheel_spinning_code")
...
![assemble_car](../attachments/lab4/assemble_car.JPG "assemble_car")
...
![fd_lower_limit_code](../attachments/lab4/fd_lower_limit_code.png "fd_lower_limit_code")
...
![on-axis_turn_code](../attachments/lab4/on-axis_turn_code.png "on-axis_turn_code")
...
![cali_code](../attachments/lab4/cali_code.png "cali_code")
...
![cali_factor_plot_code](../attachments/lab4/cali_factor_plot_code.png "cali_factor_plot_code")

![cali_factor_plot](../attachments/lab4/cali_factor_plot.png "cali_factor_plot")
...
![open_loop_control_code](../attachments/lab4/open_loop_control_code.png "open_loop_control_code")
