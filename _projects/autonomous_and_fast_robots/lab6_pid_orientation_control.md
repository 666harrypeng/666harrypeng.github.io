...
toc: true
redirect_from:
  - /projects/autonomous-and-fast-robots-cornell/lab6-pid-orientation-control/
---
{% include toc %}
...
![pid_orient_debug_readings_code](../attachments/lab6/pid_orient_debug_readings_code.png "pid_orient_debug_readings_code")

On the PC, I used another notification handler function to receive, parse and store the data.

![notification_handler_code](../attachments/lab6/notification_handler_code.png "notification_handler_code")
...
![yaw_integration](../attachments/lab6/yaw_integration.png "yaw_integration")

From the official document of the IMU, there is the angular rate's modes:

![imu_property](../attachments/lab6/imu_property.png "imu_property")
...
![pid_status_ini](../attachments/lab6/pid_status_ini.png "pid_status_ini")
...
![yawErr_kp_2](../attachments/lab6/yawErr_kp_2.png "yawErr_kp_2")

The P value vs time:

![yaw_pid_kp_2](../attachments/lab6/yaw_pid_kp_2.png "yaw_pid_kp_2")
...
![yawErr_kp_2_ki_01](../attachments/lab6/yawErr_kp_2_ki_01.png "yawErr_kp_2_ki_01")

The P&I vs time: (*Note* Ignore the Derivative term here)

![yaw_pid_kp_2_ki_01](../attachments/lab6/yaw_pid_kp_2_ki_01.png "yaw_pid_kp_2_ki_01")
...
![kd_code](../attachments/lab6/kd_code.png "kd_code")

After tests, I found that when kp=2, ki=0.07, the general performance was pretty good and stable.

The error vs time plot:

![full_pid_yaw_err](../attachments/lab6/full_pid_yaw_err.png "full_pid_yaw_err")

The PID values vs time:

![full_yaw_pid_value](../attachments/lab6/full_yaw_pid_value.png "full_yaw_pid_value")
