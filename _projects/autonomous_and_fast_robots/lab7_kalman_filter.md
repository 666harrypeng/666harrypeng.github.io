...
toc: true
redirect_from:
  - /projects/autonomous-and-fast-robots-cornell/lab7-kalman-filter/
---
{% include toc %}
...
![kf_block_diagram](../attachments/lab7/kf_block_diagram.png "kf_block_diagram")

And for PID control system, the block diagram can be shown as:

![kf_block_diagram_pid](../attachments/lab7/kf_block_diagram_pid.png "kf_block_diagram_pid")
...
![kf_alg](../attachments/lab7/kf_alg.png "kf_alg")

where we have the notations as:

![kf_parameters](../attachments/lab7/kf_parameters.png "kf_parameters")
...
![ss_equations](../attachments/lab7/ss_equations.png "ss_equations")
...
![KALMAN_FILTER_TEST_code](../attachments/lab7/KALMAN_FILTER_TEST_code.png "KALMAN_FILTER_TEST_code")
...
![pwm](../attachments/lab7/pwm.png "pwm")

The distance readings from ToF were:

![distance_time](../attachments/lab7/distance_time.png "distance_time")
...
![velocity_time](../attachments/lab7/velocity_time.png "velocity_time")
...
![pwm_2](../attachments/lab7/pwm_2.png "pwm_2")

The distance readings from ToF:

![distance_time_2](../attachments/lab7/distance_time_2.png "distance_time_2")

The velocity:

![velocity_time_2](../attachments/lab7/velocity_time_2.png "velocity_time_2")

To calculate drag, we look at the steady state speed:

![derive_d](../attachments/lab7/derive_d.png "derive_d")

As for momentum, use the rise time to calculate:

![derive_m](../attachments/lab7/derive_m.png "derive_m")

Based on these two groups of data, I calculated the drag and momentum as follows:

Drag and Momentum from group1:

![d_m](../attachments/lab7/d_m.png "d_m")

From group2:

![d_m_2](../attachments/lab7/d_m_2.png "d_m_2")

The average of them:

![average_d_m](../attachments/lab7/average_d_m.png "average_d_m")
...
![noise_covariance](../attachments/lab7/noise_covariance.png "noise_covariance")
...
![sigma_ini](../attachments/lab7/sigma_ini.png "sigma_ini")
...
![AB_discrete](../attachments/lab7/AB_discrete.png "AB_discrete")

In Python code, I implemented them as:

![ABC_Ad_Bd_code](../attachments/lab7/ABC_Ad_Bd_code.png "ABC_Ad_Bd_code")
...
![load_data](../attachments/lab7/load_data.png "load_data")
...
![kf_func_code](../attachments/lab7/kf_func_code.png "kf_func_code")

Next, loop every data point using the filter:

![kf_application](../attachments/lab7/kf_application.png "kf_application")

I plotted the curve from measurement and the curve with Kalman filter as follows:

![kf_tof_plot](../attachments/lab7/kf_tof_plot.png "kf_tof_plot")
...
![trust_more_measurement](../attachments/lab7/trust_more_measurement.png "trust_more_measurement")
...
![kf_global_var](../attachments/lab7/kf_global_var.png "kf_global_var")

I then used a function called ***kf*** to handle the kalman filter's updates and predictions:

![kf_code_on_robot](../attachments/lab7/kf_code_on_robot.png "kf_code_on_robot")

In the PID control main case code block, I replaced the linear extrapolation with the Kalman Filter:

![kf_in_pid_position_control](../attachments/lab7/kf_in_pid_position_control.png "kf_in_pid_position_control")
...
![sigma_002_01_2_distance_time](../attachments/lab7/sigma_002_01_2_distance_time.png "sigma_002_01_2_distance_time")

If we zoom in, we can easily find that the prediction line relied more on the model instead of the real measurement:

![sigma_002_01_2_zoom_distance_time](../attachments/lab7/sigma_002_01_2_zoom_distance_time.png "sigma_002_01_2_zoom_distance_time")

The distance error from the target distance vs time image:

![sigma_002_01_2_error_time](../attachments/lab7/sigma_002_01_2_error_time.png "sigma_002_01_2_error_time")
...
![sigma_2_1_002_distance_time](../attachments/lab7/sigma_2_1_002_distance_time.png "sigma_2_1_002_distance_time")
...
![sigma_2_1_002_zoom_distance_time](../attachments/lab7/sigma_2_1_002_zoom_distance_time.png "sigma_2_1_002_zoom_distance_time")

The distance error from the target distance vs time image:

![sigma_2_1_002_error_time](../attachments/lab7/sigma_2_1_002_error_time.png "sigma_2_1_002_error_time")
...
![sigma_005_01_02distance_time](../attachments/lab7/sigma_005_01_02distance_time.png "sigma_005_01_02distance_time")

If we zoom in, we can easily find that the prediction made a quite good job:

![sigma_005_01_02zoom_distance_time](../attachments/lab7/sigma_005_01_02zoom_distance_time.png "sigma_005_01_02zoom_distance_time")

The distance error from the target distance vs time image:

![sigma_005_01_02error_time](../attachments/lab7/sigma_005_01_02error_time.png "sigma_005_01_02error_time")
