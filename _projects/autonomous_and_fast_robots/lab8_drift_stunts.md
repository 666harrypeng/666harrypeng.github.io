...
toc: true
redirect_from:
  - /projects/autonomous-and-fast-robots-cornell/lab8-drift-stunts/
---
...
![drift_distance_bound](../attachments/lab8/drift_distance_bound.png "drift_distance_bound")
...
![drift_code](../attachments/lab8/drift_code.png "drift_code")
...
![kf_after_drift](../attachments/lab8/kf_after_drift.png "kf_after_drift")
...
![demo1_yaw](../attachments/lab8/demo1_yaw.png "demo1_yaw")

![demo1_yaw_err](../attachments/lab8/demo1_yaw_err.png "demo1_yaw_err")

The PWM duty cycle:

![demo1_pwm](../attachments/lab8/demo1_pwm.png "demo1_pwm")

The ToF distance reading with Kalman Filter:

![demo1_tof_kf](../attachments/lab8/demo1_tof_kf.png "demo1_tof_kf")
...
![demo1_pid](../attachments/lab8/demo1_pid.png "demo1_pid")
...
![demo2_yaw](../attachments/lab8/demo2_yaw.png "demo2_yaw")

![demo2_yaw_err](../attachments/lab8/demo2_yaw_err.png "demo2_yaw_err")

The PWM duty cycle:

![demo2_pwm](../attachments/lab8/demo2_pwm.png "demo2_pwm")

The ToF distance reading with Kalman Filter:

![demo2_tof_kf](../attachments/lab8/demo2_tof_kf.png "demo2_tof_kf")

The PID values for position control:

![demo2_pid](../attachments/lab8/demo2_pid.png "demo2_pid")
...
![demo3_yaw](../attachments/lab8/demo3_yaw.png "demo3_yaw")

![demo3_yaw_err](../attachments/lab8/demo3_yaw_err.png "demo3_yaw_err")

The PWM duty cycle:

![demo3_pwm](../attachments/lab8/demo3_pwm.png "demo3_pwm")

The ToF distance reading with Kalman Filter:

![demo3_tof_kf](../attachments/lab8/demo3_tof_kf.png "demo3_tof_kf")

The PID values for position control:

![demo3_pid](../attachments/lab8/demo3_pid.png "demo3_pid")
