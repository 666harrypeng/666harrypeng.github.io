...
toc: true
redirect_from:
  - /projects/autonomous-and-fast-robots-cornell/lab9-mapping/
---
...
![continuous_rotate_code](../attachments/lab9/continuous_rotate_code.png "continuous_rotate_code")
...
![continuous_rotation_precision_compare](../attachments/lab9/continuous_rotation_precision_compare.png "continuous_rotation_precision_compare")
...
![mapping_court](../attachments/lab9/mapping_court.jpeg "mapping_court")
...
![reading_data_processing](../attachments/lab9/reading_data_processing.png "reading_data_processing")

Then, they would all be transformed by the function ***translation*** as:

![translation_function](../attachments/lab9/translation_function.png "translation_function")
...
![p1_dist_reading_2d](../attachments/lab9/p1_dist_reading_2d.png "p1_dist_reading_2d")

![p1_dist_reading_polar](../attachments/lab9/p1_dist_reading_polar.png "p1_dist_reading_polar")

***Point 2 -> (5, 3)***:

![p2_dist_reading_2d](../attachments/lab9/p2_dist_reading_2d.png "p2_dist_reading_2d")

![p2_dist_reading_polar](../attachments/lab9/p2_dist_reading_polar.png "p2_dist_reading_polar")

***Point 3 -> (0, 0)***:

![p3_dist_reading_2d](../attachments/lab9/p3_dist_reading_2d.png "p3_dist_reading_2d")

![p3_dist_reading_polar](../attachments/lab9/p3_dist_reading_polar.png "p3_dist_reading_polar")

***Point 4 -> (-3, -2)***:

![p4_dist_reading_2d](../attachments/lab9/p4_dist_reading_2d.png "p4_dist_reading_2d")

![p4_dist_reading_polar](../attachments/lab9/p4_dist_reading_polar.png "p4_dist_reading_polar")

***Point 5 -> (5, -3)***:

![p5_dist_reading_2d](../attachments/lab9/p5_dist_reading_2d.png "p5_dist_reading_2d")

![p5_dist_reading_polar](../attachments/lab9/p5_dist_reading_polar.png "p5_dist_reading_polar")
...
![mapping_final_plot_1](../attachments/lab9/mapping_final_plot_1.png "mapping_final_plot_1")

According to this image, I can guess and highlight the wall and the objects manually as:

![mapping_with_highlighted_wall](../attachments/lab9/mapping_with_highlighted_wall.jpeg "mapping_with_highlighted_wall")
