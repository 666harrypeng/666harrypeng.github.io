...
teaser: /images/teasers/respiratory-architecture-imagegen-v2.png
teaser_width: 1672
teaser_height: 941
authors: "Group Leader, Principal Contributor"
venue: "HKUST, ECE Final Year Project (FYP), self-proposed"
advisor: "[Prof. Jun ZHANG](https://ece.hkust.edu.hk/eejzhang)"
...
description: 'Developed **MHA-VAE-LSTM** for respiratory forecasting and anomaly detection, achieving >95% detection accuracy and ≥10% better reconstruction than VAE-LSTM. Integrated sensors, real-time inference, and ESP-NOW communication into an **end-to-end monitoring system** with sustained latency below 50 ms.'
redirect_from:
  - /projects/respiratory-monitoring-system-hkust-fyp/
keywords: VAE, LSTM, Multi-Head Attention, Anomaly Detection, Time-Series Prediction, Sleep Apnea, ESP32, ESP-NOW
stack: Python, PyTorch, C++
---
...
<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/system_diagram.png" alt="system_diagram" style="max-width: 100%; height: auto;">
  </figure>
</div>

## Hardware System Setup

The hardware system collects air humidity, air temperature, and audio signals from the patient's breathing. The audio signals are collected by a microphone (KY-038), and the air humidity and temperature are collected by the sensor AHT10. Once the sensor signal buffers are full, the data will be transmitted to the ESP32 board via the ESP-NOW protocol. The general hardware system structure is shown as the following figure:

<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/hw_system_diagram_corrected.png" alt="hw_system_diagram" style="max-width: 100%; height: auto;">
  </figure>
</div>
...
<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/Dataset_Construction_workflow.png" alt="Dataset_Construction_workflow" style="max-width: 100%; height: auto;">
  </figure>
</div>
...
<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/Anomaly_detection_workflow.png" alt="Anomaly_detection_workflow" style="max-width: 100%; height: auto;">
  </figure>
</div>
...
<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/MHA_VAE_ModelStucture_resized.jpg" alt="MHA_VAE_ModelStucture_resized" style="max-width: 80%; height: auto;">
  </figure>
</div>

By introducing the Multi-Head Attention (MHA) mechanism and the residual connection, the model can have a better performance in the data feature extraction and reconstruction, especially compared with the `VAE-LSTM` model which uses the VAE to extract local features and uses the LSTM to make future predictions.

The following figure shows the reconstruction results for the `VAE-LSTM` model.

<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/vae_reconstruction_val_epoch_2700.png" alt="vae_reconstruction_val_epoch_2700" style="max-width: 100%; height: auto;">
  </figure>
</div>
...
<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/mha-vae_reconstruction_val_epoch_1250.png" alt="mha-vae_reconstruction_val_epoch_1250" style="max-width: 100%; height: auto;">
  </figure>
</div>
...
<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/pure_lstm_anomaly_detection_comparison_thre80-noseinout9-winlen800-lookback1.png" alt="pure_lstm_anomaly_detection_comparison_thre80-noseinout9-winlen800-lookback1" style="max-width: 100%; height: auto;">
  </figure>
</div>
...
<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/vae-lstm_anomaly_detection_comparison_thre80-noseinout9-winlen800-lookback1.png" alt="vae-lstm_anomaly_detection_comparison_thre80-noseinout9-winlen800-lookback1" style="max-width: 100%; height: auto;">
  </figure>
</div>
...
<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/mha_vae_lstm_win_len1000_look_back1_anomaly_detection_comparison_thre80.png" alt="mha_vae_lstm_win_len1000_look_back1_anomaly_detection_comparison_thre80" style="max-width: 100%; height: auto;">
  </figure>
</div>
...
<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/short_length_compare.png" alt="short_length_compare" style="max-width: 100%; height: auto;">
  </figure>
</div>
...
<div style="display: flex; justify-content: center; text-align: center;">
  <figure>
    <img src="attachments/long_length_compare.png" alt="long_length_compare" style="max-width: 100%; height: auto;">
  </figure>
</div>
...
This project developed an open-source research prototype for real-time respiratory anomaly monitoring. The system was evaluated in controlled academic settings and has not been clinically validated.
