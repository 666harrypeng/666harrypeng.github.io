---
title: "Vision and Learning for Robotics Manipulation and Grasping"
layout: project
date: 2025-02-14
toc: true

teaser: /projects/vision_and_learning_for_robotics_manipulation_and_grasping/_project_teaser/robot_manip_teaser-poster.jpg
teaser_width: 480
teaser_height: 268
teaser_video: /projects/vision_and_learning_for_robotics_manipulation_and_grasping/_project_teaser/robot_manip_teaser.mp4
...
description: 'Trained and evaluated [GraspCNN1](https://arxiv.org/abs/1804.05172) & [GraspCNN2](https://journals.sagepub.com/doi/10.1177/0278364919859066) and [PoseCNN](https://arxiv.org/abs/1711.00199) models for robotic arm manipulation, designing **grasp synthesis strategies** and validating the grasping pipeline in **simulated and real-world settings**.'
redirect_from:
  - /projects/intelligent-robots-and-embodied-ai-hkust-elec4260/project3-robotic-grasping/
  - /projects/vision_and_learning_for_robotics_manipulation_and_grasping/project3_robotic_grasping/
  - /projects/vision-and-learning-for-robotics-manipulation-and-grasping-hkust-elec4260/
...
stack: "Python, PyTorch, OpenCV, RealSense Stereo Camera, [AIRBOT Play](https://airbots.online/)"
---
...
Trained and evaluated ***[GraspCNN1](https://arxiv.org/abs/1804.05172)*** & ***[GraspCNN2](https://journals.sagepub.com/doi/10.1177/0278364919859066)*** and ***[PoseCNN](https://arxiv.org/abs/1711.00199)*** models for robotic arm manipulation, designing grasp synthesis strategies and validating the grasping pipeline in simulated and real-world settings.
...
An alternative would be to tune the relative weights of the segmentation, centermap, and rotation losses. This approach was not evaluated in this project; ICP was used to refine the pose estimates instead.
...
I implemented [GGCNN](https://arxiv.org/abs/1804.05172) and [GGCNN2](https://journals.sagepub.com/doi/10.1177/0278364919859066) for data-driven grasp detection and integrated the grasping pipeline with the robotic arm.
